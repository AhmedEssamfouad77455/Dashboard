...
export default function SideBar({ open , handleDrawerClose}) {
    ...
    const Drawer = styled(MuiDrawer, { shouldForwardProp: (prop) => prop !== 'open' })(
      ...
      const array1 = [
        { text: "Dashboard", icon: <HomeOutlinedIcon />, path: "/", id: "1" },
        { text: "Mange Team", icon: <GroupIcon />, path: "/team", id: "2" },
        {
          text: "Contents information",
          icon: <ContactsIcon />,
          path: "/contents",
          id: "3",
        },
      ...
      const array2 = [
        { text: "Profile Form", icon: <PersonIcon />, path: "/form", id: "1" },
        {
          text: "Calendar",
        ...
        { text: "FQA Page", icon: <HelpOutlineIcon />, path: "/fqa", id: "3" },
      ];
      const array3 = [
        { text: "Bar Chart ", icon: <BarChartIcon />, path: "/bar", id: "1" },
        { text: "Pie Chart", icon: <PieChartOutlineIcon />, path: "/pie", id: "2" },
        { text: "Line Chart", icon: <ShowChartIcon />, path: "/line", id: "3" },
        { text: "Geography", icon: <MapIcon />, path: "/geography", id: "4" },
      ];
...
const native = useNavigate()
  ...
  return (
    ...
    <Drawer variant="permanent" open={open}>
        ...
        <List>
          {array1.map((item) => (
            <ListItem key={item.id} disablePadding sx={{ display: 'block' , background:location.pathname == item.path ? theme.palette.mode == "light" ? grey[300] : grey[900] : null ,  }}
            onClick={()=>{
              native(item.path)
